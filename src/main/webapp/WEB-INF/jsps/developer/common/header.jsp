...
<title>APP开发者平台</title>
	...
	<link href="${pageContext.request.contextPath }/static/css/dropzone.min.css" rel="stylesheet">
	<!-- Custom Theme Style -->
	<link href="${pageContext.request.contextPath }/static/css/custom.min.css"	rel="stylesheet">
	
	<!-- add localcss 2016-8-18 -->
	<link href='${pageContext.request.contextPath }/static/localcss/appinfoadd.css' rel='stylesheet'>
	<link href='${pageContext.request.contextPath }/static/localcss/appinfolist.css' rel='stylesheet'>
</head>
				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						<div class="profile_pic">
							<img
								src="${pageContext.request.contextPath }/static/images/img.jpg"
