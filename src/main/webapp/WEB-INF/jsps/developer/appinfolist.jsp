...
<script src="${pageContext.request.contextPath }/static/localjs/rollpage.js"></script>
<script src="${pageContext.request.contextPath }/static/localjs/appinfolist.js"></script>